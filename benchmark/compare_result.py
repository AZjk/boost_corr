"""Module for comparing benchmark results.
This module contains functions to compare benchmark results for the boost_corr package.
"""
...
with h5py.File(
    target_dir
    + "/B981_2_10k_star_dynamic_0p1Hz_Strain1.01mm_Ampl0.005mm_att5_Lq0_001_0001-0800.hdf",
    "r",
) as f:
...
imm = ImmDataset(
    "/scratch/xpcs_data_raw/B981_2_10k_star_dynamic_0p1Hz_Strain1.01mm_Ampl0.005mm_att5_Lq0_001/B981_2_10k_star_dynamic_0p1Hz_Strain1.01mm_Ampl0.005mm_att5_Lq0_001_00001-00800.imm"
)
