"""Module for GPU twotime correlation.

This module implements the two-time correlation solver and related functions.
...
def solve_twotime_base(
    ...
    **kwargs,
    ...
    if save_results:
        with XpcsResult(
            meta_dir, qmap, output, overwrite=overwrite, twotime_config=analysis_kwargs
        ) as result_file:
